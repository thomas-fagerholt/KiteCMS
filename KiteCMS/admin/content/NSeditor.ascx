<%@ Control Language="c#" AutoEventWireup="false" Codebehind="NSeditor.ascx.cs" Inherits="KiteCMS.Admin.NSeditor" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
...
<td>
	<div class="tbButton" TITLE="<% Response.Write(KiteCMS.Functions.localText("bold"));%>" onclick="document.getElementById('tbContent').contentWindow.document.execCommand('Bold',false,null);" onmouseover="button_over(this);" onmouseout="button_out(this);">
		<img class="tbIcon" src="/admin/editor/images/bold.gif" WIDTH="23" HEIGHT="22"/>
	</div>
</td>
<td>
	<div class="tbButton" TITLE="<% Response.Write(KiteCMS.Functions.localText("italic"));%>" onclick="document.getElementById('tbContent').contentWindow.document.execCommand('Italic',false,null);" onmouseover="button_over(this);" onmouseout="button_out(this);">
		<img class="tbIcon" src="/admin/editor/images/Italic.gif" WIDTH="23" HEIGHT="22"/>
	</div>
</td>
<td>
	<div class="tbButton" TITLE="<% Response.Write(KiteCMS.Functions.localText("underline"));%>" onclick="document.getElementById('tbContent').contentWindow.document.execCommand('Underline',false,null);" onmouseover="button_over(this);" onmouseout="button_out(this);">
		<img class="tbIcon" src="/admin/editor/images/under.gif" WIDTH="23" HEIGHT="22"/>
	</div>
</td>
<td width=1 class="tbSeparator"><img src=/admin/images/space.gif width=1 height=1/></td>
<td>
	<div class="tbButton" TITLE="<% Response.Write(KiteCMS.Functions.localText("align_left"));%>" onclick="document.getElementById('tbContent').contentWindow.document.execCommand('justifyLeft',false,null);" onmouseover="button_over(this);" onmouseout="button_out(this);">
		<img class="tbIcon" src="/admin/editor/images/left.gif" WIDTH="23" HEIGHT="22"/>
	</div>
</td>
<td>
	<div class="tbButton" TITLE="<% Response.Write(KiteCMS.Functions.localText("align_center"));%>" onclick="document.getElementById('tbContent').contentWindow.document.execCommand('justifycenter',false,null);" onmouseover="button_over(this);" onmouseout="button_out(this);">
		<img class="tbIcon" src="/admin/editor/images/center.gif" WIDTH="23" HEIGHT="22"/>
	</div>
</td>
<td>
	<div class="tbButton" TITLE="<% Response.Write(KiteCMS.Functions.localText("align_right"));%>" onclick="document.getElementById('tbContent').contentWindow.document.execCommand('justifyright',false,null);" onmouseover="button_over(this);" onmouseout="button_out(this);">
...
<td width=1 class="tbSeparator"><img src=/admin/images/space.gif width=1 height=1/></td>
<td>
	<div class="tbButton" TITLE="<% Response.Write(KiteCMS.Functions.localText("bullist"));%>" onclick="document.getElementById('tbContent').contentWindow.focusCurrentContentholder();document.execCommand('insertunorderedlist',false,null);" onmouseover="button_over(this);" onmouseout="button_out(this);">
