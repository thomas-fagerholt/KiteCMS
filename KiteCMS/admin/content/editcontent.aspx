<%@ Register TagPrefix="uc1" TagName="IEeditor" Src="IEeditor.ascx" %>
<%@ Register TagPrefix="uc1" TagName="NSeditor" Src="NSeditor.ascx" %>
<%@ Page language="jscript" Codebehind="editcontent.aspx.cs" AutoEventWireup="false" Inherits="KiteCMS.Admin.editcontent" validateRequest="false" %>
