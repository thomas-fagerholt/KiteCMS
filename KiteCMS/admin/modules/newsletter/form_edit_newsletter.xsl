...
<input type="hidden" name="action" value="doeditnewsletter"/>
<input type="hidden" name="emailcategory" value="{//selectedemailtype}"/>
...
<tr>
	...
	<td>
		<input type="text" name="title" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/title}"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input type="text" name="onSubscribe" class="alminput" size="50" value="{//emailcategory[@id=//selectedemailtype]/onSubscribe}"/>
	</td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('atunsubscribe')"/>:</td>
	<td>
		<input type="text" name="onUnSubscribe" class="alminput" size="50" value="{//emailcategory[@id=//selectedemailtype]/onUnSubscribe}"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input type="text" name="header" class="alminput" size="50" value="{//emailcategory[@id=//selectedemailtype]/header}"/>
	</td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('emailfooter')"/>:</td>
	<td>
		<input type="text" name="footer" class="alminput" size="50" value="{//emailcategory[@id=//selectedemailtype]/footer}"/>
	</td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('emailsender')"/>:</td>
	<td>
		<input type="text" name="sender" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/sender}"/>
	</td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('emailhtmlformat')"/>:</td>
	<td>
	<xsl:element name="input">
	<xsl:attribute name="type">checkbox</xsl:attribute>
	<xsl:attribute name="name">blnHTML</xsl:attribute>
	<xsl:if test="//emailcategory[@id=//selectedemailtype]/blnHTML=1">
...
<tr>
	<td><xsl:value-of select="util:localText('emailarchive')"/>:</td>
	<td>
	<xsl:element name="input">
	<xsl:attribute name="type">checkbox</xsl:attribute>
	<xsl:attribute name="name">archive</xsl:attribute>
	<xsl:if test="//emailcategory[@id=//selectedemailtype]/archive=1">
		<xsl:attribute name="checked"/>
	</xsl:if>
	</xsl:element>
	</td>
...
<tr>
	...
	<td>
		<input type="text" name="rsstitle" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/rsstitle}"/>
	</td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('rssdescription')"/>:</td>
	<td>
		<input type="text" name="rssdescription" class="alminput" size="50" value="{//emailcategory[@id=//selectedemailtype]/rssdescription}"/>
	</td>
</tr>
<tr>
	<td></td>
	...
	<input type="button" class="almknap" value="{util:localText('cancel')}" onclick="document.location.href='default.aspx?pageid={//selectedpage}';return false;"/>&#160;
	</td>
</tr>
<tr>
