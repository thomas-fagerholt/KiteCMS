...
<tr>
	...
	<td>
		<input type="text" name="onSubscribe" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/onSubscribe}"/>
	</td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('atunsubscribe')"/>:</td>
	<td>
		<input type="text" name="onUnSubscribe" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/onUnSubscribe}"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input type="text" name="header" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/header}"/>
	</td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('emailfooter')"/>:</td>
	<td>
		<input type="text" name="footer" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/footer}"/>
	</td>
</tr>
<tr>
...
<tr>
	...
	<td>
		<input type="text" name="rssdescription" class="alminput" size="50" maxlength="250" value="{//emailcategory[@id=//selectedemailtype]/rssdescription}"/>
	</td>
</tr>
<tr>
	<td></td>
