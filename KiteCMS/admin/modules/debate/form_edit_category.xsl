...
<tr>
	...
	<td width="300"><input type="text" name="title" class="alminput" size="50" maxlength="250" value="{//category[@id=$categoryid]/title}"/></td>
</tr>
<tr>
	<td width="150"><xsl:value-of select="util:localText('adminemail')"/>:</td>
	<td width="300"><input type="text" name="adminemail" class="alminput" size="50" maxlength="250" value="{//category[@id=$categoryid]/adminemail}"/></td>
</tr>
<tr>
...
<tr>
	...
	<td width="300"><input type="text" name="subject" class="alminput" size="50" maxlength="250" value="{//category[@id=$categoryid]/emailsubject}"/></td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('headerbeforelink')"/>:</td>
	<td><input type="text" name="header" class="alminput" size="50" maxlength="250" value="{//category[@id=$categoryid]/emailheader}"/></td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('footer')"/>:</td>
	<td><input type="text" name="footer" class="alminput" size="50" maxlength="250" value="{//category[@id=$categoryid]/emailfooter}"/></td>
</tr>
<tr>
	<td><xsl:value-of select="util:localText('emailsender')"/>:</td>
	<td><input type="text" name="sender" class="alminput" size="50" maxlength="250" value="{//category[@id=$categoryid]/emailsender}"/></td>
</tr>
<tr>
	<td></td>
	<td>
