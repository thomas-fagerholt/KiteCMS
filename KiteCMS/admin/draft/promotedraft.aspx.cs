...
namespace KiteCMS.Admin
{
	...
	/// </summary>
	public class promotedraft : System.Web.UI.Page
	{
		...
		private void Page_Load(object sender, System.EventArgs e)
		{
			...
			admin.userHasAccess(1304,pageId);
			header.Text = Functions.localText("promotedraft");
		...
		private void funcDeleteDraft(int pageId)
		{
			...
			if (page.HasDraft == 1)
			{
				page.ContentHolders = page.DraftContentHolders;
				page.HasDraft = 0;

				page.Save();

				content.Text += Functions.localText("draftpromoted") + Functions.publicUrl();
			}
			else
